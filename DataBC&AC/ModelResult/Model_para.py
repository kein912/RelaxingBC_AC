...
# "_GP"
model = ["_DT","_RF", "_SVM", "_LR", "_KN", "_AD", "_GB", "_MLP" ]
# 
modelFunc = [DecisionTreeClassifier(), RandomForestClassifier(), LogisticRegression(penalty='l2'), GaussianProcessClassifier(), KNeighborsClassifier(), AdaBoostClassifier(estimator=DecisionTreeClassifier()), GradientBoostingClassifier(), MLPClassifier()]
# , SVC()
model_para_dic = {
                ...
                'gamma': ['scale',1e-3, 1e-4,'auto'],
                'probability':[True],
                'C': range(1,100), 
                'random_state': [0, 42],
                "class_weight":[ 'balanced',{0:2},  {0:3} ]
                },
